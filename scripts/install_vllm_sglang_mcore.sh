...
if [ $USE_SGLANG -eq 1 ]; then
    pip install -i https://pypi.tuna.tsinghua.edu.cn/simple "sglang[all]==0.4.6.post1" --no-cache-dir --find-links https://flashinfer.ai/whl/cu124/torch2.6/flashinfer-python && pip install torch-memory-saver --no-cache-dir -i https://pypi.tuna.tsinghua.edu.cn/simple
fi
...
# https://github.com/Dao-AILab/flash-attention/releases/download/v2.8.2/flash_attn-2.8.2+cu12torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl
